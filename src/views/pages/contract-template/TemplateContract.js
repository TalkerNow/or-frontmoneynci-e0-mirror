...
class TemplateContract extends React.Component {
  ...
  calculate = () => {
    ...
    this.state.formValues["TTC5"] = Math.trunc(
      (parseInt(HT5) + parseInt(nbHT5)) * VTA
    );
    ...
    this.state.formValues["TVA"] = Math.trunc(
      (TOTALHT * input_values["TVAP"]) / 100
    );
  ...
  sendForm = () => {
    ...
    axios
      .put(
        global.config.server_url + "/contract_templates/1",
        parameters,
        Config
      )
            ...
            <InputGroup>
              ...
              <InputGroupAddon addonType="append">
                <Button.Ripple color="primary" outline>
                  Envoyer <span className="d-none d-md-inline">le contrat</span>
                </Button.Ripple>
              </InputGroupAddon>
            </InputGroup>
          </Col>
          ...
          >
            <div style={{ overflowX: "auto", width: "100%" }}>
              <Card
                ...
                style={{ padding: "1.5rem 2.5rem 2.2rem 2.5rem", minWidth: "800px" }}
              >
              <CardBody>
                <Row>
                  <Col md="12" sm="12">
                ...
                <div className="text-left pt-3 contract-footer">
                  ...
                  <div>
                    <Input
                      ...
                      onChange={(e) =>
                        this.setState({ general_condition: e.target.value })
                      }
                    />
                  </div>
                </div>
                <div className="text-center pt-3 contract-footer">
                  <p>
