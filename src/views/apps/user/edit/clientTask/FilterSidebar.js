          ...
          <div className="todo-app-menu">
            <div className="add-task">
                ...
                <Button.Ripple
                    ...
                    color="primary"
                    onClick={() => {
                        history.push('/app/user/edit/'+this.props.id+'/1');
                    }}
                >
                    Back To Clients
                </Button.Ripple>
            ...
            >
              <ListGroup className="font-medium-1">
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/all"
                          ? true
                          : false
                    }
                >
              ...
              <ListGroup className="font-medium-1">
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/unread"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/important"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/completed"
                          ? true
                          : false
                    }
                >
              ...
              <ListGroup className="font-medium-1">
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/relance_caisse"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/relance_client"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/envoi_caisse"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/envoi_client"
                          ? true
                          : false
                    }
                >
                  ...
                  <ListGroupItem
                      ...
                      active={
                          this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/appel_client"
                              ? true
                              : false
                      }
                  >
                  ...
                  <ListGroupItem
                      ...
                      active={
                          this.props.routerProps.location.pathname === "/app/user/clientTask/"+this.props.id+"/appel_caisse"
                              ? true
                              : false
                      }
                  >
