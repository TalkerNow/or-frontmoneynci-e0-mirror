...
import { X, Layers, Star, Info, Check } from "react-feather"
import { connect } from "react-redux"
import { changeFilter } from "../../../../../redux/actions/member-todo/index"
          ...
          <div className="todo-app-menu">
            <div className="add-task">
                {this.props.customer &&
                    <>
                        <div style={{
                            ...
                            {this.props.customer.personal_informations.first_name + " " +
                             this.props.customer.personal_informations.last_name}
                        </div>
                        <div style={{color:'green', fontSize:'11px', width:'100%', textAlign:'center'}}>
                ...
                <Button.Ripple
                    ...
                    color="primary"
                    onClick={() => {
                        history.push('/app/member/edit/'+this.props.id+'/1');
                    }}
                >
                    Back To Members
                </Button.Ripple>
            ...
            >
              <ListGroup className="font-medium-1">
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/all"
                          ? true
                          : false
                    }
                >
              ...
              <ListGroup className="font-medium-1">
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/unread"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/important"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/completed"
                          ? true
                          : false
                    }
                >
                ...
                {/*    }}*/}
                {/*    active={*/}
                {/*      this.props.routerProps.location.pathname === "/memberTask/trashed"*/}
                {/*          ? true*/}
                {/*          : false*/}
                {/*    }*/}
                {/*>*/}
              ...
              <ListGroup className="font-medium-1">
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/relance_caisse"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/relance_client"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/envoi_caisse"
                          ? true
                          : false
                    }
                >
                ...
                <ListGroupItem
                    ...
                    active={
                      this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/envoi_client"
                          ? true
                          : false
                    }
                >
                  ...
                  <ListGroupItem
                      ...
                      active={
                          this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/appel_client"
                              ? true
                              : false
                      }
                  >
                  ...
                  <ListGroupItem
                      ...
                      active={
                          this.props.routerProps.location.pathname === "/app/user/memberTask/"+this.props.id+"/appel_caisse"
                              ? true
                              : false
                      }
                  >
