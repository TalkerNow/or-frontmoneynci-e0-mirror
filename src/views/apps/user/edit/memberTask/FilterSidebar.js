          ...
          >
            <ListGroup className="font-medium-1">
              <ListGroupItem
                ...
                active={
                  ...
                  "/app/user/memberTask/" + this.props.id + "/all"
                    ? true
                    : false
                }
              >
            ...
            <ListGroup className="font-medium-1">
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/unread"
                    ? true
                    : false
                }
              >
              ...
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/important"
                    ? true
                    : false
                }
              >
              ...
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/completed"
                    ? true
                    : false
                }
              >
            ...
            <ListGroup className="font-medium-1">
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/relance_caisse"
                    ? true
                    : false
                }
              >
              ...
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/relance_client"
                    ? true
                    : false
                }
              >
              ...
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/envoi_caisse"
                    ? true
                    : false
                }
              >
              ...
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/envoi_client"
                    ? true
                    : false
                }
              >
              ...
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/appel_client"
                    ? true
                    : false
                }
              >
              ...
              <ListGroupItem
                ...
                active={
                  this.props.routerProps.location.pathname ===
                  "/app/user/memberTask/" + this.props.id + "/appel_caisse"
                    ? true
                    : false
                }
              >
