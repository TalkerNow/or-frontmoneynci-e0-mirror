      ...
      {mode === "production" && (
        <div>
          ...
          <div style={{ ...S.card, padding: 14, marginBottom: 14 }}>
            <div style={{ fontSize: 13, fontWeight: 700, marginBottom: 8 }}>{"\u{1F4CE}"} Documents</div>
            {!docsUploaded ? (
              <div onClick={() => setDocsUploaded(true)} style={{ border: "2px dashed #6C5CE7", borderRadius: 9, padding: "20px 14px", textAlign: "center", cursor: "pointer", background: "#6C5CE706" }}>
                ...
                <div style={{ fontWeight: 600, color: "#6C5CE7", fontSize: 11 }}>D&eacute;posez tous vos documents ici</div>
                <div style={{ fontSize: 10, color: "#bbb", marginTop: 4 }}>{"\u{1F4A1}"} Cliquez pour simuler</div>
              </div>
            ) : (
              <div>
                  ...
                  {(() => {
                    ...
                    if (expandedPanel === "carriere") {
                      ...
                      const ASSIMILES_TYPES = [
                        "Maladie / AT-MP", "Maternit\u00e9", "Ch\u00f4mage indemnis\u00e9",
                        "Invalidit\u00e9", "Service militaire", "Ch\u00f4mage non indemnis\u00e9",
                      ];
                            ...
                            return (
                              <div key={reg.id} style={{ marginBottom: 8, border: `1px solid ${reg.color}30`, borderRadius: 9, overflow: "hidden" }}>
                                          ...
                                          <thead>
                                            <tr style={{ background: "#6C5CE710" }}>
                                              {["Ann\u00e9e", "Sal. r\u00e9els F/\u20AC", "Sal. SS F/\u20AC", "Coeff.", "Sal. revaloris\u00e9s", "D\u00e9pla.", "Trim.", "AR", "Total"].map((h) => (
                                                <th key={h} style={{ padding: "5px 6px", textAlign: "right", fontWeight: 700, color: "#6C5CE7", borderBottom: "1px solid #6C5CE720", whiteSpace: "nowrap" }}>{h}</th>
                                              ))}
                                            </tr>
                                          </thead>
                                          <tbody>
                                            {MOCK_CNAV.map((row, i) => (
                                              <tr key={row.yr} style={{ background: i % 2 === 0 ? "#fff" : "#fafafa" }}>
                                                <td style={{ padding: "4px 6px", fontWeight: 700, color: "#333" }}>{row.yr}</td>
                                                <td style={{ padding: "4px 6px", textAlign: "right", color: "#555" }}>{row.sal.toLocaleString("fr-FR")}</td>
                                                <td style={{ padding: "4px 6px", textAlign: "right", color: "#555" }}>{row.ss.toLocaleString("fr-FR")}</td>
                                                <td style={{ padding: "4px 6px", textAlign: "right", color: "#0984E3", fontWeight: 600 }}>{row.coeff}</td>
                                                <td style={{ padding: "4px 6px", textAlign: "right", fontWeight: 700, color: "#1a1a2e" }}>{row.revalo.toLocaleString("fr-FR")}</td>
                                                <td style={{ padding: "4px 6px", textAlign: "center" }}>
                                                  {row.yr <= 2004 ? <input type="checkbox" disabled={carriereValidee} style={{ cursor: carriereValidee ? "default" : "pointer" }} /> : <span style={{ color: "#ddd", fontSize: 11 }}>&mdash;</span>}
                                                </td>
                                                <td style={{ padding: "4px 6px", textAlign: "center" }}><input type="number" defaultValue={row.trim} disabled={carriereValidee} style={{ width: 32, textAlign: "center", border: "1px solid #ddd", borderRadius: 4, fontSize: 10, padding: "1px 2px" }} /></td>
                                                <td style={{ padding: "4px 6px", textAlign: "center" }}><input type="number" defaultValue={row.ar} disabled={carriereValidee} style={{ width: 32, textAlign: "center", border: "1px solid #ddd", borderRadius: 4, fontSize: 10, padding: "1px 2px" }} /></td>
                                                <td style={{ padding: "4px 6px", textAlign: "center", fontWeight: 700, color: "#6C5CE7" }}>{row.total}</td>
                                              </tr>
                                            ))}
                                          </tbody>
                                        </table>
                                      ...
                                      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                                        <div style={{ border: "1px solid #6C5CE720", borderRadius: 8, overflow: "hidden" }}>
                                          ...
                                          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 10 }}>
                                            ...
                                            <tbody>
                                              {ASSIMILES_TYPES.map((type, i) => (
                                                <tr key={i} style={{ background: i % 2 === 0 ? "#fff" : "#fafafa" }}>
                                                  <td style={{ padding: "4px 8px", color: "#444" }}>{type}</td>
                                                  <td style={{ padding: "4px 8px", textAlign: "center" }}><input type="number" defaultValue={0} disabled={carriereValidee} style={{ width: 36, textAlign: "center", border: "1px solid #ddd", borderRadius: 4, fontSize: 10, padding: "1px 2px" }} /></td>
                                                  <td style={{ padding: "4px 8px" }}><button disabled={carriereValidee} style={{ fontSize: 9, padding: "2px 6px", borderRadius: 4, border: "1px solid #6C5CE740", background: "#6C5CE710", color: "#6C5CE7", cursor: carriereValidee ? "default" : "pointer" }}>+ Ajouter</button></td>
                                                </tr>
                                              ))}
                                            </tbody>
                                          </table>
                                          <div style={{ padding: "5px 8px", fontSize: 9, color: "#888", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 4 }}>
                                            <span>Enfants : <strong>3</strong></span>
                                            <span>Genre : <strong>M</strong></span>
                                            <span>Statut : <strong>Salari&eacute;</strong></span>
                                          </div>
                                          <div style={{ padding: "2px 8px 6px", fontSize: 9, color: "#888" }}>Handicap : <strong>Non</strong></div>
                                        </div>
                                        ...
                                        <div style={{ border: "1px solid #6C5CE720", borderRadius: 8, overflow: "hidden" }}>
                                          ...
                                          <div style={{ padding: "4px 9px", fontSize: 10, color: "#555", maxHeight: 180, overflowY: "auto" }}>
                                            {[...MOCK_CNAV].sort((a, b) => b.revalo - a.revalo).slice(0, 25).map((r) => (
                                              <div key={r.yr} style={{ display: "flex", justifyContent: "space-between", padding: "2px 0", borderBottom: "1px solid #f0f0f0" }}>
                                                <span style={{ color: "#888" }}>{r.yr}</span>
                                                <span style={{ fontWeight: 700 }}>{r.revalo.toLocaleString("fr-FR")} &euro;</span>
                                              </div>
                                            ))}
                                          </div>
                                          <div style={{ padding: "6px 9px", borderTop: "1px solid #6C5CE720", fontSize: 10 }}>
                                            <div style={{ display: "flex", justifyContent: "space-between", fontWeight: 700 }}><span>SAM (25 meilleures)</span><span style={{ color: "#6C5CE7" }}>38 420 &euro;</span></div>
                                            <div style={{ display: "flex", justifyContent: "space-between", color: "#888" }}><span>Moyenne annuelle</span><span>32 100 &euro;</span></div>
                                          </div>
                                        </div>

                                        <div style={{ display: "flex", gap: 7 }}>
                                          <button disabled={carriereValidee} style={{ flex: 1, padding: "8px 0", borderRadius: 7, border: "none", background: carriereValidee ? "#ddd" : "#6C5CE7", color: "#fff", fontWeight: 700, fontSize: 11, cursor: carriereValidee ? "default" : "pointer" }}>{"\u25B6"} Simuler</button>
                                          <button disabled={carriereValidee} style={{ padding: "8px 12px", borderRadius: 7, border: "1px solid #ddd", background: "#fafafa", color: "#888", fontSize: 11, cursor: carriereValidee ? "default" : "pointer" }}>{"\u21BA"} R&eacute;initialiser</button>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                {isOpen && reg.id === "agirc" && (
                                  <div style={{ padding: "12px 13px" }}>
                                    <div style={{ display: "flex", gap: 12, marginBottom: 10 }}>
                                      {["Non-Cadre", "Cadre"].map((opt) => (
                                        <label key={opt} style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 11, fontWeight: 600, cursor: "pointer" }}>
                                          <input type="radio" name="cadre" defaultChecked={opt === "Non-Cadre"} disabled={carriereValidee} /> {opt}
                                        </label>
                                      ))}
                                    </div>
                                      ...
                                      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 10 }}>
                                        <thead>
                                          <tr style={{ background: "#0984E310" }}>
                                            {["Ann\u00e9e", "Salaire F/\u20AC", "Taux TA", "Taux TB", "Sal. r\u00e9f. F/\u20AC", "Tranche A", "Tranche B", "TOTAL"].map((h) => (
                                              <th key={h} style={{ padding: "5px 7px", textAlign: "right", fontWeight: 700, color: "#0984E3", borderBottom: "1px solid #0984E320", whiteSpace: "nowrap" }}>{h}</th>
                                            ))}
                                          </tr>
                                        </thead>
                                        <tbody>
                                          {MOCK_AGIRC.map((row, i) => (
                                            <tr key={row.yr} style={{ background: i % 2 === 0 ? "#fff" : "#fafafa" }}>
                                              <td style={{ padding: "4px 7px", fontWeight: 700, color: "#333" }}>{row.yr}</td>
                                              <td style={{ padding: "4px 7px", textAlign: "right" }}><input type="number" defaultValue={row.sal} disabled={carriereValidee} style={{ width: 72, textAlign: "right", border: "1px solid #ddd", borderRadius: 4, fontSize: 10, padding: "1px 3px" }} /></td>
                                              <td style={{ padding: "4px 7px", textAlign: "right", color: "#888" }}>{row.ta}%</td>
                                              <td style={{ padding: "4px 7px", textAlign: "right", color: "#888" }}>{row.tb}%</td>
                                              <td style={{ padding: "4px 7px", textAlign: "right", color: "#888" }}>{row.ref.toLocaleString("fr-FR")}</td>
                                              <td style={{ padding: "4px 7px", textAlign: "right", fontWeight: 600, color: "#0984E3" }}>{row.trA.toLocaleString("fr-FR")}</td>
                                              <td style={{ padding: "4px 7px", textAlign: "right", fontWeight: 600, color: "#0984E3" }}>{row.trB.toLocaleString("fr-FR")}</td>
                                              <td style={{ padding: "4px 7px", textAlign: "right", fontWeight: 700, color: "#1a1a2e" }}>{row.total.toLocaleString("fr-FR")}</td>
                                            </tr>
                                          ))}
                                        </tbody>
                                      </table>
                                    </div>
                                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 10px", borderRadius: 7, background: "#0984E310", marginBottom: 10 }}>
                                      <span style={{ fontSize: 11, fontWeight: 700, color: "#0984E3" }}>Points relev&eacute; (RIS)</span>
                                      <input type="number" defaultValue={148320} disabled={carriereValidee} style={{ width: 100, textAlign: "right", border: "1px solid #0984E340", borderRadius: 5, fontSize: 11, padding: "3px 6px", fontWeight: 700, color: "#0984E3" }} />
                                    </div>
                                    <div style={{ display: "flex", gap: 7 }}>
                                      <button disabled={carriereValidee} style={{ flex: 1, padding: "8px 0", borderRadius: 7, border: "none", background: carriereValidee ? "#ddd" : "#0984E3", color: "#fff", fontWeight: 700, fontSize: 11, cursor: carriereValidee ? "default" : "pointer" }}>{"\u{1F4E5}"} Importer depuis RIS</button>
                                      <button disabled={carriereValidee} style={{ padding: "8px 12px", borderRadius: 7, border: "1px solid #ddd", background: "#fafafa", color: "#888", fontSize: 11, cursor: carriereValidee ? "default" : "pointer" }}>{"\u21BA"} R&eacute;initialiser</button>
                                    </div>
                                  </div>
                                )}
                                ...
                                {isOpen && reg.id === "ircantec" && (
                                  <div style={{ padding: "14px 13px", color: "#888", fontSize: 11 }}><em>IRCANTEC &mdash; donn&eacute;es &agrave; importer depuis le RIS. Section &agrave; d&eacute;velopper.</em></div>
                                )}
                                {isOpen && reg.id === "rci" && (
                                  <div style={{ padding: "14px 13px", color: "#888", fontSize: 11 }}><em>RCI / SSI &mdash; donn&eacute;es &agrave; importer depuis le relev&eacute; de carri&egrave;re SSI. Section &agrave; d&eacute;velopper.</em></div>
                                )}
                                {isOpen && reg.id === "per" && (
