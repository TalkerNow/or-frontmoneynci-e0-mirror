...
export default function IrcantecSimulator({ user }) {
  ...
  const handleSimulateur = useCallback((salaireBrut, year) => {
    ...
    const cotisB =
      Math.max(0, Math.min(salaire, 8 * plafondAnnuel) - plafondAnnuel) * tauxB;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .ircantec-simulator .custom-card { border-radius: 12px; box-shadow: 0 4px 14px rgba(15,23,42,0.05); margin-bottom: 16px; border: 1px solid #e2e8f0; }
        .ircantec-simulator .custom-card-header { background: transparent; border-bottom: 1px solid #e2e8f0; padding: 14px 16px; border-radius: 12px 12px 0 0 !important; cursor: pointer; display: flex; justify-content: space-between; align-items: center; min-height: 50px; }
        .ircantec-simulator .custom-card-header.collapsed-header { border-bottom: none; border-radius: 12px !important; }
        .ircantec-simulator .sim-title { font-weight: 800; font-size: 16px; color: #1f2d3d; text-transform: uppercase; margin: 0 !important; padding: 0 !important; letter-spacing: 0.02em; display: flex; align-items: center; }
        .ircantec-simulator .releve-row { display: flex; align-items: center; gap: 16px; margin-bottom: 12px; flex-wrap: wrap; }
        .ircantec-simulator .releve-label { font-weight: 600; font-size: 14px; min-width: 200px; }
        .ircantec-simulator .releve-input { width: 140px !important; }
      `}</style>
      <div className="ircantec-simulator">
        <div className="container-inner">
          ...
          <Card className="custom-card">
            ...
            >
              <h5 className="sim-title">POINTS RELEVÉ DE CARRIÈRE IRCANTEC</h5>
