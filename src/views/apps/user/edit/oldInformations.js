            ...
            <Row>
                <Col md="6" sm="12" style={{marginTop:'20px'}}>
                    ...
                    <FormGroup style={{marginTop:'10px'}}>
                        {this.props.perso['cl_civilite'] != null &&
                         <>
                            <div className="d-inline-block mr-1">
                                <Radio
                                    label="Monsieur"
                                    color="primary"
                                    defaultChecked={this.props.perso['cl_civilite'] === 'Monsieur'? true: false}
                                    name="cl_civilite"
                            ...
                            <div className="d-inline-block mr-1">
                                <Radio
                                    label="Madame"
                                    color="primary"
                                    defaultChecked={this.props.perso['cl_civilite'] === "Madame"? true: false}
                                    name="cl_civilite"
                            ...
                            <div className="d-inline-block mr-1">
                                <Radio
                                    label="Mlle"
                                    color="primary"
                                    defaultChecked={this.props.perso['cl_civilite'] === "Mlle"? true: false}
                                    name="cl_civilite"
