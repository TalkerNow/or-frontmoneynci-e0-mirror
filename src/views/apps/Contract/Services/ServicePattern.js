...
class ServicePattern extends React.Component {
  state = {
    defaultAlert : false,
    confirmAlert : false,
    cancelAlert : false,
        ...
        cellRendererFramework: params => {
          return (
              <div
                  ...
                  onClick={() => history.push("/app/SubServicePattern/" + params.data.id)}
              >
              ...
              <div className="ag-theme-material ag-grid-table">
                <div className="ag-grid-actions d-flex justify-content-between flex-wrap mb-1">
                  ...
                  <div className="filter-actions d-flex">
                    ...
                    />
                    <div>
                      <Button.Ripple className="mr-1 mb-1" outline color="primary" onClick={() => history.push("/app/user/createService")}>
                        <PlusSquare size={15} />
                      </Button.Ripple>
                    </div>
