            ...
            >
                            ...
                            {strategicAnalysis && (
                                <>
                                    ...
                                    {strategicAnalysis.profil_psy && (
                                        <div style={{ backgroundColor: "#fff", padding: "12px", borderRadius: "8px", marginBottom: "8px", border: "1px solid #f3f4f6" }}>
                                            <div style={{ fontWeight: "bold", color: "#7c3aed" }}>Profil: {strategicAnalysis.profil_psy.label || strategicAnalysis.profil_psy}</div>
                                            {strategicAnalysis.profil_psy.description && <div style={{ fontSize: "13px", color: "#666" }}>{strategicAnalysis.profil_psy.description}</div>}
                                        </div>
                                    )}
                       ...
                       */}
                                    <div className="analysis-grid">
                                        ...
                                        {strategicAnalysis.douleur_critique && (
                                            <div style={{ backgroundColor: "#fff", border: "1px solid #fee2e2", borderLeft: "4px solid #dc2626", padding: "12px", borderRadius: "8px", marginBottom: "8px" }}>
                                                <div style={{ fontWeight: "800", color: "#991b1b", fontSize: "11px", textTransform: "uppercase", display: "flex", alignItems: "center", gap: "4px" }}><AlertCircle size={14} /> Point de Douleur</div>
                                                <div style={{ fontWeight: "700" }}>{strategicAnalysis.douleur_critique.titre || strategicAnalysis.douleur_critique}</div>
                                            </div>
                                        )}
                                        {/* Mines */}
                                        {strategicAnalysis.mines_enterrees && (
                                            <div style={{ backgroundColor: "#fff", border: "1px solid #fef3c7", borderLeft: "4px solid #d97706", padding: "12px", borderRadius: "8px", marginBottom: "8px" }}>
                                                <div style={{ fontWeight: "800", color: "#92400e", fontSize: "11px", textTransform: "uppercase", display: "flex", alignItems: "center", gap: "4px" }}><Target size={14} /> Mines Enterrées</div>
                                                <ul style={{ margin: 0, paddingLeft: "18px", fontSize: "13px" }}>
                                                    {strategicAnalysis.mines_enterrees.map((m, i) => <li key={i}>{m.point || m}</li>)}
                                                </ul>
                                            </div>
                                        )}
                                        {/* Leviers */}
                                        {strategicAnalysis.leviers_closing && (
                                            <div style={{ backgroundColor: "#fff", border: "1px solid #d1fae5", borderLeft: "4px solid #059669", padding: "12px", borderRadius: "8px", marginBottom: "8px" }}>
                                                <div style={{ fontWeight: "800", color: "#065f46", fontSize: "11px", textTransform: "uppercase", display: "flex", alignItems: "center", gap: "4px" }}><TrendingUp size={14} /> Leviers</div>
                                                <ul style={{ margin: 0, paddingLeft: "18px", fontSize: "13px" }}>
                                                    {strategicAnalysis.leviers_closing.map((l, i) => <li key={i}>{l.piste || l}</li>)}
                                                </ul>
                                            </div>
                                        )}
                                    </div>
                ...
                {selectedItem.type !== "call" && selectedItem.type !== "email" && (
                    <div style={{ marginTop: "24px", marginBottom: "24px" }}>
                        <div className="header-btn-stack" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                            <h3 style={{ fontWeight: 600, color: "#374151", fontSize: "16px", margin: 0 }}>Réponse Rapide</h3>
                            {!aiDraft && !isGeneratingAi && (
                                <button onClick={onGenerateAiReply} className="btn-sm btn-light-primary" style={{ display: "flex", alignItems: "center", gap: "6px", borderRadius: "999px" }}>
                        ...
                        {aiDraft && (
                            <div style={{ border: "1px solid #e9d5ff", borderRadius: "8px", overflow: "hidden" }}>
                                <div style={{ backgroundColor: "#f3e8ff", padding: "8px 16px", borderBottom: "1px solid #e9d5ff", display: "flex", justifyContent: "space-between" }}>
                                    <span style={{ fontSize: "12px", fontWeight: "bold", color: "#6b21a8" }}>Suggestion IA</span>
                                    <XCircle size={14} style={{ cursor: "pointer", color: "#9333ea" }} onClick={() => setAiDraft(null)} />
                                </div>
                                <textarea className="form-control" style={{ border: "none", minHeight: "150px" }} defaultValue={aiDraft} />
                            </div>
                        )}
                    </div>
                )}
                ...
                {/* Actions Section */}
                <div style={{ marginTop: "0", paddingTop: "24px", borderTop: "1px solid #f3f4f6" }}>
                    <h3 style={{ fontWeight: 600, color: "#374151", marginBottom: "16px", fontSize: "16px" }}>Actions standards</h3>
                    <ActionsSection
