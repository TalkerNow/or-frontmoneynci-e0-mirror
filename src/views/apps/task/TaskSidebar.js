        ...
        >
          ...
          <PerfectScrollbar>
            <div className="task-body">
              ...
              <FormGroup style={{marginBottom:'10px'}}>
                {(() => {
                  if(this.props.receivers.length > 0 && this.props.taskToUpdate !== null){
                    var selected_receiver = this.props.receivers.find(obj => {
                      return obj.value == taskReceiver
                    });
                    if(selected_receiver && selected_receiver.subscribe_services != null) {
                      return <div>
                              <span
                      ...
                      return <div>
                                <span
                                    className={`bullet bullet-warning bullet-xs`}
                                />
                                <span className="text-capitalize" style={{marginLeft:'10px'}}>
                                    No Subscribe
                                </span>
