...
class UserView extends React.Component {
  ...
  async componentDidMount() {
    ...
    try {
      const res = await axios.get(
        `${global.config.server_url}/documents/user/${userid}`,
        Config,
      );
    ...
    try {
      const resT = await axios.get(
        `${global.config.server_url}/customer_tasks?filter=all&user_id=${userid}`,
        Config,
      );
  ...
  handlePasswordChange = async (e) => {
    ...
    if (!currentPassword || !newPassword || !confirmPassword) {
      this.setState({
        alert: { type: "danger", message: "Tous les champs sont requis." },
      });
      return;
    }
    ...
    return (
      <React.Fragment>
        <Row className="align-items-start">
          <Col
            md="4"
            className={classnames("profile-left profile-sidebar-fixed", {
          ...
          >
            <div>
              <UserDetails
                ...
                onEdit={() =>
                  history.push(
                    `/app/member/edit/${localStorage.getItem("userid")}/1`,
                  )
                }
                showCollapse
            ...
            >
              {this.state.isCollapsed && (
                <NavItem>
                  ...
                  >
                    <Circle
                      className="toggle-icon icon-x font-medium-4 text-primary"
                      size={20}
                    />
                  </NavLink>
                </NavItem>
              ...
              <NavItem>
                <NavLink
                  id="documents-link-profile"
                  className={classnames({
                    active: this.state.activeTab === "documents",
                  })}
                  onClick={() => this.toggleTab("documents")}
                >
              ...
              <NavItem>
                <NavLink
                  ...
                  onClick={() => this.toggleTab("commentaires")}
                >
                ...
                <NavItem>
                  <NavLink
                    ...
                    onClick={() => this.toggleTab("simulateur")}
                  >
            ...
            <TabContent activeTab={this.state.activeTab}>
              ...
              <TabPane tabId="security">
                <Card className="mb-1 shadow-sm rounded-2xl">
                  ...
                  <CardBody>
                    <Label className="font-weight-bold mb-50">
                    ...
                    <form onSubmit={this.handlePasswordChange}>
                      <div className="row mt-1">
                        <div className="col-md-6 mb-1">
                          ...
                          <div className="d-flex">
                            <Input
                              type={
                                this.state.showCurrent ? "text" : "password"
                              }
                      ...
                      <div className="mt-1">
                        <p className="font-weight-bold mb-50">
              ...
              <TabPane tabId="notes">
                <Card className="mb-1 shadow-sm rounded-2xl">
                  ...
                  <CardBody>
                    <FormGroup>
                      <Label for="notes" className="fw-bold mb-1">
                        Infos
                      </Label>
                      <Input
                        type="textarea"
                    ...
                    <div className="d-flex justify-content-end">
                      <Button color="primary" onClick={this.handleSaveNotes}>
                        Enregistrer
                      </Button>
                    </div>
                  </CardBody>
              ...
              <TabPane tabId="documents">
                <DocumentsHub
                  ...
                  labelId={"documents-label-profile"}
                />
              </TabPane>
              ...
              <TabPane tabId="tasks">
                <Card className="mb-1 shadow-sm rounded-2xl">
                  <CardHeader className="pb-0">
                    <CardTitle tag="h5" className="d-flex align-items-center">
                      <CheckSquare className="text-primary mr-50" size={18} />{" "}
                      Tâches
                    </CardTitle>
                  </CardHeader>
                  <CardBody>
              ...
              <TabPane tabId="commentaires">
                <Card className="mb-1 shadow-sm rounded-2xl">
                  <CardHeader className="pb-0">
                    <CardTitle tag="h5" className="d-flex align-items-center">
                      <MessageCircle className="text-primary mr-50" size={18} />{" "}
                      Commentaires
                    </CardTitle>
                  </CardHeader>
                  <CardBody>
